...
### DEFINE PARAMETERS
db_names <- c("../data/remesas/REMESAS0100011930.txt")
...
original_params = list(R = 10000, warmup = 0, verbose = 1, bayes_model = NULL)
original_mcmc_params = list(R = 500, warmup = 250, verbose = 1, bayes_model = bayes_model_original)
new_params = list(R = 250, warmup = 250, verbose = 1, bayes_model = bayes_model_new)
